...
### 🖼️ Brand Landing Page (`docs/hero.png`)
...
### 🥬 Product Catalog Overview (`docs/homepage.png`)
...
### 🔍 Detailed Item View (`docs/product.png`)
...
### ❤️ Saved Favorites (`docs/wishlist.png`)
...
### 🛒 Real-Time Cart System (`docs/cart.png`)
...
### 📦 Order History & Tracking (`docs/orders.png`)
...
### 🛠️ Django Admin Control Center (`docs/django.png`)
